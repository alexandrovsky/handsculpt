...
public static class MeshSubdivide
{
	...
	public static void Subdivide4Triangle(Mesh mesh, int[] triangles, int triangleIndex)
	{
		int i1 = triangles[triangleIndex + 0];
		int i2 = triangles[triangleIndex + 1];
		int i3 = triangles[triangleIndex + 2];
	...
	public static void Subdivide4(Mesh mesh)
	{
		...
		{
			Subdivide4Triangle(mesh,triangles, i);
		}
